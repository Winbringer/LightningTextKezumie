...
namespace Game1
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Art.Load(Content);
            lightningText = new LightningText(GraphicsDevice, spriteBatch, lightningFont, "Kezumie");
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(infoFont,"For Nami by Victorem. Press space to change mode", new Vector2(5, 30), Color.White);
